...
These operations may take some time for large numbers of messages. The app will report the total number of SMS and MMS messages imported or exported, or calls exported, and the elapsed time, upon successful conclusion.
