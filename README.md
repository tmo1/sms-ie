...
Current versions of SMS Import / Export should run on any Android (phone-like) device with API level >= 19 ([Android 4.4 KitKat](https://developer.android.com/about/versions/kitkat) or later), although encryption and decryption are only available on devices with API level >= 21; message import and scheduled message export are only available on devices with API level >= 23 ([Android 6.0 Marshmallow](https://developer.android.com/about/versions/marshmallow) or later); and blocked numbers import and export are only available on devices with API level >= 24 ([Android 7.0 Nougat](https://developer.android.com/about/versions/nougat) or later).

The app is tested primarily on stock Android and [LineageOS](https://lineageos.org/), but should generally run on other versions of Android as well. There are a number of reports of the app running well on [GrapheneOS](https://grapheneos.org/). Chinese Android forks such as [MIUI](https://en.wikipedia.org/wiki/MIUI) and [EMUI](https://en.wikipedia.org/wiki/EMUI) have a history of customizing Android in ways that break the app - see issues [#87](https://github.com/tmo1/sms-ie/issues/87), [#103](https://github.com/tmo1/sms-ie/issues/103), [#152](https://github.com/tmo1/sms-ie/issues/152), [#164](https://github.com/tmo1/sms-ie/issues/164), [#210](https://github.com/tmo1/sms-ie/issues/210), and [#232](https://github.com/tmo1/sms-ie/issues/232), and PR [#236](https://github.com/tmo1/sms-ie/pull/236).
...
Some operations may take a considerable amount time for large amounts of data. When importing or exporting, the app will report the total number of SMS and MMS messages, calls, contacts, or blocked numbers imported or exported, and the elapsed time, upon successful conclusion.
